    ...
    <main class="container py-4 py-lg-5" id="wizard-main">
        ...
        <form data-wizard novalidate>
            ...
            <section class="wizard-step surface-card wizard-panel" id="wizard-step-4" role="tabpanel" aria-labelledby="step-title-4">
                ...
                <div class="alert alert-light border mt-4 mb-0"><i class="bi bi-megaphone me-2" aria-hidden="true"></i>Kampagnenmaterial und Medien folgen im nächsten Projektschritt. Parlamentarische Evidenz kann bereits vollständig gespeichert werden.</div>
