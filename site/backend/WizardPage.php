...
<body data-insight-id="$encodedId">
    ...
    <main class="container py-4 py-lg-5" id="wizard-main">
        ...
        <form data-wizard aria-busy="true" novalidate>
            ...
            <section class="wizard-step" id="wizard-step-3" role="tabpanel" aria-labelledby="step-title-3">
                ...
                <div class="ai-filter-launch surface-card mb-3" data-ai-filter-launch>
                    <div class="d-flex flex-column flex-lg-row align-items-lg-center gap-3">
                        <div class="flex-grow-1"><p class="eyebrow mb-1"><i class="bi bi-stars me-1" aria-hidden="true"></i>Experimentelle Vorauswahl</p><h3 class="h5 mb-1">Abstimmungen mit einem Kriterium eingrenzen</h3><p class="small text-body-secondary mb-0" data-ai-availability>Die KI-Vorauswahl ist eine zusätzliche, jederzeit entfernbare Suchhilfe. Sie ist weder offiziell noch geprüft und wählt keine Evidenz aus.</p></div>
                        <div class="ai-filter-launch-action"><button class="btn btn-outline-primary w-100" type="button" data-ai-open disabled><i class="bi bi-stars me-1" aria-hidden="true"></i>Mit KI eingrenzen</button></div>
                    </div>
                    <div class="ai-filter-active mt-3 d-none" data-ai-active role="status" aria-live="polite"><div class="d-flex flex-column flex-md-row align-items-md-center gap-2"><span class="badge rounded-pill text-bg-info"><i class="bi bi-funnel me-1" aria-hidden="true"></i>KI-Filter aktiv</span><span class="small flex-grow-1" data-ai-active-copy></span><button class="btn btn-sm btn-outline-secondary" type="button" data-ai-clear>Filter entfernen</button></div></div>
                </div>
    ...
    <div class="modal fade" id="ai-filter-modal" tabindex="-1" aria-labelledby="ai-filter-modal-title" aria-describedby="ai-filter-disclosure" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <form class="modal-content ai-filter-modal" data-ai-form>
                <div class="modal-header align-items-start"><div><p class="eyebrow mb-1"><i class="bi bi-stars me-1" aria-hidden="true"></i>Experimentelle Suchhilfe</p><h2 class="modal-title h3 mb-1" id="ai-filter-modal-title">Mit KI eingrenzen</h2><p class="small text-body-secondary mb-0">Formuliere, welche Abstimmungen zu deinem Argument passen könnten.</p></div><button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Schliessen"></button></div>
                <div class="modal-body">
                    <div class="alert alert-info ai-disclosure" id="ai-filter-disclosure"><div class="d-flex gap-3"><i class="bi bi-shield-check fs-4" aria-hidden="true"></i><div><strong>KI-Vorauswahl, keine Tatsachenklassifikation</strong><p class="small mb-0 mt-1">Dein Kriterium und die angezeigten öffentlichen Parlamentsfelder werden zur Verarbeitung an OpenAI gesendet. Identität, Kampagnenmaterial und deine Insight-Einordnung werden nicht übermittelt. Prüfe jeden Treffer selbst; erst deine separate Evidenzauswahl wird gespeichert.</p></div></div></div>
                    <div class="ai-scope-summary rounded-3 p-3 mb-3" data-ai-scope-summary></div>
                    <div class="mb-2"><label class="form-label fw-semibold" for="ai-filter-criterion">Auswahlkriterium</label><textarea class="form-control form-control-lg" id="ai-filter-criterion" rows="4" minlength="3" maxlength="1000" placeholder="z. B. Vorlagen, die Sozialleistungen kürzen oder den Zugang dazu erschweren" data-ai-criterion></textarea><div class="d-flex justify-content-between gap-3 form-text"><span>Beschreibe Thema, gewünschte Wirkung oder ausdrückliche Ausschlüsse.</span><span><span data-ai-character-count>0</span>/1000</span></div></div>
                    <div class="ai-example-list d-flex flex-wrap gap-2 mb-3" aria-label="Beispiele"><button class="btn btn-sm btn-outline-secondary" type="button" data-ai-example="Vorlagen zu Steuerentlastungen für Unternehmen oder hohe Einkommen">Steuerentlastungen</button><button class="btn btn-sm btn-outline-secondary" type="button" data-ai-example="Vorlagen zum Ausbau der Grundversorgung, aber keine reinen Verfahrensanträge">Grundversorgung ohne Verfahren</button><button class="btn btn-sm btn-outline-secondary" type="button" data-ai-example="Abstimmungen zur Regulierung digitaler Plattformen">Digitale Plattformen</button></div>
                    <div class="alert alert-danger d-none" data-ai-error role="alert" tabindex="-1"></div>
                    <div class="ai-progress rounded-3 p-4 d-none" data-ai-progress role="status" aria-live="polite"><div class="d-flex align-items-center gap-3"><span class="spinner-border text-primary" aria-hidden="true"></span><div><strong class="d-block" data-ai-progress-title>Geeignete Abstimmungen werden gesucht …</strong><span class="small text-body-secondary" data-ai-progress-copy>Zuerst wird eine Suchstrategie erstellt, danach werden nur passende Kandidaten geprüft.</span></div></div><div class="operation-progress mt-3" role="progressbar" aria-label="KI-Auswahl läuft"><span></span></div></div>
                    <div class="d-none" data-ai-results aria-live="polite">
                        <div class="d-flex flex-column flex-md-row justify-content-between gap-2 align-items-md-end mb-3"><div><p class="eyebrow mb-1">Vorauswahl</p><h3 class="h5 mb-0" data-ai-result-summary></h3></div><span class="small text-body-secondary" data-ai-cache-note></span></div>
                        <div class="alert alert-warning d-none" data-ai-stale><strong>Dieses Ergebnis ist nicht mehr aktuell.</strong> Mitgliederkreis, Rahmen oder Suchtext wurden verändert. Starte die Vorauswahl erneut, bevor du sie anwendest.</div>
                        <div class="ai-plan small mb-3" data-ai-plan></div>
                        <section class="mb-4" aria-labelledby="ai-matches-title" data-ai-match-section><div class="d-flex justify-content-between gap-2 align-items-center mb-2"><h4 class="h6 mb-0" id="ai-matches-title"><i class="bi bi-check2-circle text-success me-1" aria-hidden="true"></i>Passende Abstimmungen <span class="badge text-bg-success" data-ai-match-count>0</span></h4><span class="small text-body-secondary">Vorausgewählt</span></div><div class="ai-result-list" data-ai-matches></div></section>
                        <section aria-labelledby="ai-ambiguous-title" data-ai-ambiguous-section><div class="d-flex justify-content-between gap-2 align-items-center mb-2"><h4 class="h6 mb-0" id="ai-ambiguous-title"><i class="bi bi-question-circle text-warning me-1" aria-hidden="true"></i>Möglicherweise passend <span class="badge text-bg-warning" data-ai-ambiguous-count>0</span></h4><span class="small text-body-secondary">Bitte einzeln prüfen</span></div><div class="ai-result-list" data-ai-ambiguous></div></section>
                        <div class="ai-empty rounded-3 p-4 text-center text-body-secondary d-none" data-ai-empty><i class="bi bi-search d-block fs-3 mb-2" aria-hidden="true"></i>Keine Abstimmung erfüllt das Kriterium nachvollziehbar. Passe das Kriterium an oder nutze die normalen Filter.</div>
                    </div>
                </div>
                <div class="modal-footer ai-modal-actions"><div class="row g-2 w-100"><div class="col-12 col-md-3"><button class="btn btn-outline-danger w-100" type="button" data-ai-discard>Verwerfen</button></div><div class="col-12 col-md-3"><button class="btn btn-outline-secondary w-100" type="button" data-bs-dismiss="modal">Schliessen</button></div><div class="col-12 col-md-6"><button class="btn btn-primary w-100" type="submit" data-ai-run><i class="bi bi-stars me-1" aria-hidden="true"></i>Vorauswahl starten</button><button class="btn btn-primary w-100 d-none" type="button" data-ai-apply><i class="bi bi-funnel me-1" aria-hidden="true"></i>Als Filter anwenden</button></div></div></div>
            </form>
        </div>
    </div>
